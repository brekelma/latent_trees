...
if(~isfield(optionsEM,'initNodePot'))
    ...
    for i=1:optionsEM.numStarting
        [node_pot_int{i}, edge_pot_int{i}, ll_approx] = learnParamsEM(trainSamples,adjmatT,optionsEM);
...
[nodePot, edgePot, ll_approx] = learnParamsEM(trainSamples,adjmatT,optionsEM);
